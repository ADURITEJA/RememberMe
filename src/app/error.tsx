  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-4 text-center">
      <div className="flex flex-col items-center gap-6 max-w-md">
        <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-remme-status-emergency/12 text-remme-status-emergency">
          <HeartHandshake aria-hidden className="h-12 w-12" />
        </div>

        <div className="flex flex-col gap-2">
          <h1 className="text-4xl font-bold text-remme-ink">Something went wrong</h1>
        ...
        {error.digest && (
          <p className="text-sm text-remme-ink/40">
